...
import { How2PickSizeKids } from "./How2PickSizeKids";

export const ItemsPage5 = ({ handleColor }) => {
  ...
  const getItem = async () => {
    try {
      const response = await axios.get(
        `https://9062e60b1552f6a8.mokky.dev/kidsbikes/${id}`
      );
        ...
        <div>
                  ...
                  <label htmlFor="S_size ">
                    {product && product.size && product.size.includes("s") ? (
                      <>
                        ...
                        <span className="ml-2 font-['arial']">12" wheels</span>
                      </>
                    ) : (
                      <>
                  ...
                  <label htmlFor="M_size">
                    {product && product.size && product.size.includes("m") ? (
                      <>
                        ...
                        <span className="ml-2  font-['arial']">16" wheels</span>
                      </>
                    ) : (
                      <>
                  ...
                  <label htmlFor="L_size">
                    {product && product.size && product.size.includes("l") ? (
                      <>
                        ...
                        <span className="ml-2 font-['arial']"> 20" wheels</span>
                      </>
                    ) : (
                      <>
                  ...
                  <label htmlFor="XL_size">
                    {product && product.size && product.size.includes("xl") ? (
                      <>
                        ...
                        <span className="ml-2 font-['arial']"> 24" wheels</span>
                      </>
                    ) : (
                      <>
                  ...
                  <label htmlFor="XXL_size">
                    {product && product.size && product.size.includes("xxl") ? (
                      <>
                        ...
                        <span className="ml-2 font-['arial']">26" wheels</span>
                      </>
                    ) : (
                      <>
                        <input
          ...
          <div className="bg-[#1e1e1e] min-h-[120vh] pb-10 flex justify-center items-center">
            <div className=" bg-white w-[80%] h-[145vh]">
              ...
              <div>
                <SpecsComponent product={product} />
              </div>
              <div>
                <How2PickSizeKids />
              </div>
