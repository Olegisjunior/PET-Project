...
import { How2PickSizeAccessories } from "./How2PickSizeAccessories";
import SpecsComponent4 from "./SpecsComponent4";
  ...
  const getItem = async () => {
    try {
      const response = await axios.get(
        `https://9062e60b1552f6a8.mokky.dev/accessories/${id}`
      );
      ...
      {product && (
        <div>
          ...
          <div className="bg-[#1e1e1e] min-h-[120vh] pb-10 flex justify-center items-center">
            <div className=" bg-white w-[80%] h-[115vh]">
              ...
              <div>
                <SpecsComponent4 product={product} />
              </div>
              <div>
                <How2PickSizeAccessories product={product} />
              </div>
            </div>
          </div>
        </div>
